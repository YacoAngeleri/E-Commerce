...
document.getElementById('id-moon').onclick = function(){
    ...
    document.getElementById('sec-quienes-somos').style.color = colorText;
    document.getElementById('sec-politicas').style.background = colorText1;
    document.getElementById('sec-politicas').style.color = colorText;
...
document.getElementById('id-sun').onclick = function(){
    ...
    document.getElementById('sec-quienes-somos').style.color = colorText1;
    document.getElementById('sec-politicas').style.background = "darkgray";
    document.getElementById('sec-politicas').style.color = colorText1;
